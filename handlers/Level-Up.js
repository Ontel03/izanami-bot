...
let { mongodb } = require("../config.json");
const canvacord = require("canvacord");

module.exports = async client => {
  Levels.setURL(process.env.mongoURL); //can be putten in .env too and then imported//Add this to your main file (example: index.js or main.js)
