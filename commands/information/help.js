...
module.exports = {
  ...
  run: async (client, message, args) => {
    if (!args[0]) {
      ...
      const emo = {
        fun: "<a:troll:860055607745445908>",
        image: "<:images:859257306151518208>",
        information: "<a:paper:861803260234170368>",
        moderation: "<a:hammer:861582488861409301>",
        utility: "<a:processing:861806359564386316>",
        settings: "<a:repair:861582301305503764>"
      };
